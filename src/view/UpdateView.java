...
public class UpdateView extends JFrame {
	...
	UpdateView(PostDTO post) {
		...
		title = new JTextField(post.getTitle());
		...
		content = new JTextArea(post.getContent());
		...
		btnWrite.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				c.updatePost(PostDTO.builder().postId(post.getPostId()).userName(post.getUserName())
